...
def main():
    ...
    parser.add_argument('--output_filename', type=str, required=True, help="File name to save the text embedding response.")
    ...
    for ii, doc in enumerate(all_docs):
        ...
        process_and_save_document(doc, embedding_dir, output_filename, chunk_size=chunk_size)
...
# ** SAMPLE RUN CODE **
# CUDA_VISIBLE_DEVICES=0 python process_openai_text_embeddings.py --model_checkpoint "text-embedding-3-small" --output_filename "Data/nvidia-Llama3-ChatQA.json" --chunk_size 2750 
